...
Note lack of fit for all models due to over-dispersion.  The subject of over-dispersion is described in @howe_model_2019. This overdispersion causes AIC to select overly-complex models, so analysts should specify the number/order of adjustment terms manually when fitting distance sampling models to data from camera traps, rather than allowing automated selection using AIC. 
